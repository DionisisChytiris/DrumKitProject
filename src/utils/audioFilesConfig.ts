...
export const audioFilesConfig: Record<string, AudioFileConfig[]> = {
  ...
  snare: [
    ...
    { id: 'snare-8', name: 'Snare R&B', file: 'snareR&B.wav', type: 'snare' },
  ...
  tom: [
    ...
    { id: 'tom-1', name: 'Tom 1', file: 'rocktom1.wav', type: 'tom' },
    { id: 'tom-2', name: 'Tom 2', file: 'rocktom2.wav', type: 'tom' },
    { id: 'tom-3', name: 'Tom 3', file: 'rocktom3.wav', type: 'tom' },
    { id: 'tom-4', name: 'Tom 4', file: 'rocktom4.wav', type: 'tom' },
    { id: 'tom-5', name: 'Tom 5', file: 'rocktom5.wav', type: 'tom' },
    { id: 'tom-6', name: 'Tom 6', file: 'tom1.wav', type: 'tom' },
    { id: 'tom-7', name: 'Tom 7', file: 'tom2.wav', type: 'tom' },
    { id: 'tom-8', name: 'Tom 8', file: 'tom3.wav', type: 'tom' },
    { id: 'tom-9', name: 'Tom 9', file: 'tom4.wav', type: 'tom' },
  ...
  cymbal: [
    ...
    { id: 'bell-1', name: 'Bell 1', file: 'bell1.wav', type: 'cymbal' },
    { id: 'bell-2', name: 'Bell 2', file: 'bell2.wav', type: 'cymbal' },
    { id: 'bell-3', name: 'Bell 3', file: 'bell3.wav', type: 'cymbal' },
